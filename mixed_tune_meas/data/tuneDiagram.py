...
class tuneDiagram:
    ...
    def __init__(self, order, qx, qy, radius, p=50, qxmin=-20, qxmax=20, qymin=-20, qymax=20, fig=0):
        # update settings page to reflect current order
        for i in range(0,order,1):
            self.order[i] = True;
        self.qX = qx; self.qY = qy;
        self.n1 = self.qX; self.n2 = self.qX + 0.1;
        self.m1 = self.qY; self.m2 = self.qY + 0.1;        
        self.radius = radius;
        self.p = p;
